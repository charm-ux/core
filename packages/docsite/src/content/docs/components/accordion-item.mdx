...
import AccordionItem from '../reference/accordion-item.md';

The accordion item can be used independently or as a sub-component of the [accordion component](/docsite/components/accordion/).
...
<ch-accordion-item disabled>
  <span slot="summary">I am disabled</span>
  Accordion item content
</ch-accordion-item>
```
