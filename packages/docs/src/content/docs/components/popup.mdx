...
```html
<ch-popup open arrow-placement="end">
  <span slot="anchor"></span>
  <div class="box"></div>
</ch-popup>
```
...
```html
<ch-popup open flip flip-padding="5">
  <span slot="anchor"></span>
  <div class="box"></div>
</ch-popup>
```
...
```html
<ch-popup open hover-bridge distance="20" skidding="20">
  <span slot="anchor"></span>
  <div class="box"></div>
</ch-popup>
