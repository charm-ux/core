...
<ch-tooltip content="This is a tooltip!">
  <ch-button slot="anchor">Hover me</ch-button>
</ch-tooltip>
```
...
<div class="tooltip-hoist">
  <ch-tooltip content="This is a tooltip">
    <ch-button slot="anchor">Clipped</ch-button>
  </ch-tooltip>

  <ch-tooltip fixed-placement content="This is a tooltip">
    <ch-button slot="anchor">Fixed placement</ch-button>
  </ch-tooltip>
</div>
...
>
  <ch-button slot="anchor">Longer Delays</ch-button>
</ch-tooltip>
```
