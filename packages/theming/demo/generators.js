...
// import { color } from './themes/basic-theme/token-helpers.js';

// Empty Theme
generateTheme({
  outDir: './demo/themes/empty-theme',
});

// Basic Theme
generateTheme({
  outDir: './demo/themes/basic-theme',
  tokenPrefix: 'my',
  uniquePalettes: ['neutral', 'primary'],
  useHsl: true,
  skipAlphaColorGeneration: true,
  tokens: {
    primitives: {
      duration: {
        fast: '100ms',
...
// Theme Selector
generateTheme({
  outDir: './demo/themes/theme-selector',
  darkThemeSelector: 'html[data-theme="dark"]',
  lightThemeSelector: 'html[data-theme="light"]',
...
// Palette Generator
generateTheme({
  outDir: './demo/themes/palette-generator',
