...
const charmTokensBase = defineTokens(
  {
    ...
    components: ref => ({
      ...
      alert: {
        ...
        headingFontSize: ref('fontSize', 'md'),
        headingFontWeight: ref('fontWeight', 'semibold'),
        ...
        buttonBorder: 'none',
        buttonFontSize: ref('fontSize', 'xs'),
      ...
      card: {
        ...
        headingSize: ref('fontSize', 'lg'),
        headingWeight: ref('fontWeight', 'semibold'),
        subheadingSize: ref('fontSize', 'sm'),
        subheadingWeight: ref('fontWeight', 'normal'),
      ...
      menu: {
        ...
        groupHeadingSize: ref('fontSize', 'xxs'),
        groupHeadingWeight: ref('fontWeight', 'semibold'),
        groupHeadingLineHeight: ref('lineHeight', 'sm'),
      ...
      spinner: {
        ...
        labelFontSize: ref('fontSize', 'sm'),
        labelFontWeight: ref('fontWeight', 'normal'),
        labelLineHeight: ref('lineHeight', 'md'),
        gap: ref('spacing', 'sm'),
      ...
      // Textarea
      textareaControl: {
        inputLineHeight: ref('lineHeight', 'md'),
        inputMinHeight: '80px',
        inputMinWidth: '100%',
      },
