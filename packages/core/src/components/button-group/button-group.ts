 ...
 * @cssproperty --charm-button-pressed-border-color - Sets the pressed border color of each button.
 ...
 * @cssproperty --charm-button-border-width - Sets the border width of the button group when split.
