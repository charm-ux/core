 ...
 *
 * @cssproperty --charm-text-area-input-line-height - The line-height of the textarea control input.
 * @cssproperty --charm-text-area-input-min-height - The min-height of the textarea control input.
 * @cssproperty --charm-text-area-input-min-width - The min-width of the textarea control input.
 *
 * @dependency icon
 **/
