 ...
 *
 * @cssprop --charm-overflow-item-gap - Sets the gap between items in the overflow container.
 * @cssprop --charm-overflow-collapsing-container-display - Sets the display property of the collapsing container.
 *
