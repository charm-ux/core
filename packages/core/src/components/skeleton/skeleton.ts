 ...
 *
 * @cssprop --charm-skeleton-animation - the animation for the skeleton.
 * @cssprop --charm-skeleton-bg-color - the background color for the skeleton.
 * @cssprop --charm-skeleton-bg-size - the background image size for pulse or wave animations.
 * @cssprop --charm-skeleton-border-radius - the border radius for the skeleton.
 * @cssprop --charm-skeleton-min-height - minimum height of the skeleton.
 * @cssprop --charm-skeleton-sheen-color - the background color for the skeleton when there is animation.
 * @cssprop --charm-skeleton-width - the width of the skeleton.
 **/
