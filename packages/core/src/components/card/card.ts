 ...
 *
 * @cssprop --charm-card-bg-color - Sets the background color for the card.
 * @cssprop --charm-card-body-padding-x - Controls the horizontal padding of the card body.
 ...
 * @cssprop --charm-card-footer-padding-y - Controls the vertical padding of the card footer.
 * @cssprop --charm-card-heading-gap - Controls the gap between the heading and subheading.
 * @cssprop --charm-card-heading-padding-x - Controls the horizontal padding of the card heading.
 * @cssprop --charm-card-heading-padding-y - Controls the vertical padding of the card heading.
 * @cssprop --charm-card-heading-size - Controls the font size of the heading.
 * @cssprop --charm-card-heading-weight - Controls the font weight of the heading.
 * @cssprop --charm-card-padding - Sets the padding for the card.
 * @cssprop --charm-card-subheading-size - Controls the font size of the subheading.
 * @cssprop --charm-card-subheading-weight - Controls the font weight of the subheading.
 **/
