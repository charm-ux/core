...
<Meta title="Core/Radio Group" />

# Radio Group

A radio group is a set of radio buttons, which can have no more than one button selected at a time. For more than 5 choices, consider using a different component such as Menu.
