...
- **CHARM-006** — Form controls extend `CharmFormControlElement`; never re-implement `ElementInternals`/`formAssociated`/validity wiring. ([details](../../.agents/rules/internal/CHARM-006.md))
